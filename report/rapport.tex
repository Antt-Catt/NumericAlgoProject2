...
Nous allons maintenant étudier le conditionnement des matrices obtenues avec les factorisations de Cholesky complète et incomplète. Pour cela, on utilisera les fonctions \verb|np.linalg.cond| et \verb|np.inv().
