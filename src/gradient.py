...
print(conjgrad(A1, B1, np.full((2, 1), 0)))
...
print(conjgrad(A2, B2, np.full((3, 1), 0)))
...
print(conjgrad(A3, B3, np.full((5, 1), 0)))
...
A4 = np.dot(A4, A4.T)
B4 = np.random.rand(50, 1)
print(conjgrad(A4, B4, np.full((50, 1), 0)))
...
print(precond_conjgrad(A1, B1, np.full((2,1), 0), M1))
print(np.linalg.solve(A1, B1), "attendu")
...
print(precond_conjgrad(A2, B2, np.full((3,1), 0), M2))
print(np.linalg.solve(A2, B2), "attendu")
...
print(precond_conjgrad(A3, B3, np.full((5,1), 0), M3))
print(np.linalg.solve(A3, B3), "attendu")
...
print(precond_conjgrad(A4, B4, np.full((50,1), 0), M4))
print(np.linalg.solve(A4, B4), "attendu")
